...
class TestExtractText(unittest.TestCase):
    ...
    def test_extract_text_4(self):
        ...
        expected_12 = [{'text': ' ', 'text_index': 0}, {'text': self.span_2['text'], 'text_index': 3}]
    ...
    def test_extract_text_5(self):
        ...
        expected_12 = [{'text': ' ', 'text_index': 1}, {'text': self.span_2['text'], 'text_index': 3}]
    ...
    def test_extract_text_6(self):
        ...
        self.assertEqual(self.span_1['text'] + ' ' + self.span_2['text'], doc_text)
        self.assertEqual("", source)
    ...
    def test_spacing_1(self):
        ...
        expected_12 = [{'text': self.span_no_space_digits['text'], 'text_index': 0},
                       {'text': self.span_leading_space['text'][1:], 'text_index': 3}]
    ...
    def test_spacing_4(self):
        ...
        expected_12 = [{'text': self.span_no_space_digits['text'], 'text_index': 0},
                       {'text': self.span_surrounding_space['text'][1:], 'text_index': 3}]
    ...
    def test_spacing_7(self):
        ...
        expected_12 = [{'text': self.span_no_space_digits['text'], 'text_index': 0},
                       {'text': self.span_surrounding_space['text'][1:], 'text_index': 3},
                       {'text': self.span_no_space_digits['text'], 'text_index': 8}
                       ]


        self.assertEqual(self.span_no_space_digits['text'] + self.span_surrounding_space['text']
                         + self.span_no_space_digits['text'], doc_text)
        self.assertEqual("", source)

        self.assertDictEqual({12.0: 3}, font_sizes)
        self.assertListEqual(expected_12, text_by_size[12.0])

        self.assertDictEqual({0: 3}, flag_sizes)
        self.assertListEqual(expected_12, text_by_flag[0])
